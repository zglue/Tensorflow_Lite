...
#define M_DRV_MC36XX_CFG_RANGE E_M_DRV_MC36XX_RANGE_2G
#define M_DRV_MC36XX_CFG_RESOLUTION E_M_DRV_MC36XX_RES_12BIT
...
#define _M_DRV_MC36XX_REG_WRITE(bRegAddr, pbDataBuf, bLength) \
  mcube_write_regs(1, M_DRV_MC36XX_CFG_I2C_ADDR, bRegAddr, pbDataBuf, bLength)
#define _M_DRV_MC36XX_REG_READ(bRegAddr, pbDataBuf, bLength) \
  mcube_read_regs(1, M_DRV_MC36XX_CFG_I2C_ADDR, bRegAddr, pbDataBuf, bLength)
#else
#define _M_DRV_MC36XX_REG_WRITE(bRegAddr, pbDataBuf, bLength) \
 ...
 *** _M_DRV_MC36XX_Delay
 *****************************************************************************/
void _M_DRV_MC36XX_Delay(uint32_t dwMs) { mcube_delay_ms(dwMs); }
...
static int _M_DRV_MC36XX_SetSniffAGAIN(uint8_t SniffGain) {
  ...
  M_PRINTF("[%s] REG[0x%02X] 0x%02X\r\n", __func__, E_M_DRV_MC36XX_REG_DMX,
           _bRegAGain);
  ...
  M_PRINTF("[%s] REG[0x%02X] 0x%02X\r\n", __func__, E_M_DRV_MC36XX_REG_DMY,
           _bRegAGain);
...
static void _M_DRV_MC36XX_LowPassFilter(
  ...
  M_PRINTF("[%s]\r\n", __func__);
  M_PRINTF("[CurrData]     %d    %d    %d", _saData[M_DRV_MC36XX_AXIS_X],
           _saData[M_DRV_MC36XX_AXIS_Y], _saData[M_DRV_MC36XX_AXIS_Z]);

  M_PRINTF("[PreData]     %d    %d    %d", _saLPFPrevData[M_DRV_MC36XX_AXIS_X],
           _saLPFPrevData[M_DRV_MC36XX_AXIS_Y],
           _saLPFPrevData[M_DRV_MC36XX_AXIS_Z]);

  _saData[M_DRV_MC36XX_AXIS_X] = _M_DRV_MC36XX_SENSOR_FILTER(
      _saLPFPrevData[M_DRV_MC36XX_AXIS_X], _saData[M_DRV_MC36XX_AXIS_X]);
  _saData[M_DRV_MC36XX_AXIS_Y] = _M_DRV_MC36XX_SENSOR_FILTER(
      _saLPFPrevData[M_DRV_MC36XX_AXIS_Y], _saData[M_DRV_MC36XX_AXIS_Y]);
  _saData[M_DRV_MC36XX_AXIS_Z] = _M_DRV_MC36XX_SENSOR_FILTER(
  ...
  M_PRINTF("[M_DRV_MC36XX_SUPPORT_LPF]     %d    %d    %d",
           _saData[M_DRV_MC36XX_AXIS_X], _saData[M_DRV_MC36XX_AXIS_Y],
...
static void _M_DRV_MC36XX_SetSniffOverSR(uint8_t bDesiredSRMode) {
  ...
  if (s_bCfgSniffSRMode == bDesiredSRMode) return;
...
static void _M_DRV_MC36XX_SetWakeOverSR(uint8_t bDesiredSRMode) {
  ...
  if (s_bCfgWakeSRMode == bDesiredSRMode) return;
...
static int _M_DRV_MC36XX_SetCwakeSR(e_m_drv_mc36xx_cwake_sr_t eSR) {
  ...
  M_PRINTF("[%s] REG[0x%02X] 0x%02X\r\n", __func__, E_M_DRV_MC36XX_REG_WAKE_C,
           _bRegWAKE);
...
static int _M_DRV_MC36XX_SetSniffSR(e_m_drv_mc36xx_sniff_sr_t eSR) {
  ...
  M_PRINTF("[%s] REG[0x%02X] 0x%02X\r\n", __func__, E_M_DRV_MC36XX_REG_SNIFF_C,
           _bRegSNIFF);
...
static int _M_DRV_MC36XX_SetMode(e_m_drv_mc36xx_mode_t eNextMode) {
  ...
  switch ((int)eNextMode) {
    case E_M_DRV_MC36XX_MODE_SNIFF:
      _M_DRV_MC36XX_REG_WRITE(E_M_DRV_MC36XX_REG_PWR_CONTROL, &s_bCfgFifoVdd,
                              1);
  ...
  M_PRINTF("[%s] REG[0x%02X] 0x%02X\r\n", __func__, E_M_DRV_MC36XX_REG_MODE_C,
           _bRegMODE_C);
 ...
 *****************************************************************************/
static int _M_DRV_MC36XX_ReadRawData(
    signed short Output[M_DRV_MC36XX_AXES_NUM]) {
  M_PRINTF("[%s]\r\n", __func__);
  ...
  _M_DRV_MC36XX_REG_READ(E_M_DRV_MC36XX_REG_XOUT_LSB, (uint_dev*)_baData.words,
                         6);

  _waRaw[M_DRV_MC36XX_AXIS_X] =
      ((signed short)((_baData.bytes[0]) | (_baData.bytes[1] << 8)));
  _waRaw[M_DRV_MC36XX_AXIS_Y] =
      ((signed short)((_baData.bytes[2]) | (_baData.bytes[3] << 8)));
  _waRaw[M_DRV_MC36XX_AXIS_Z] =
      ((signed short)((_baData.bytes[4]) | (_baData.bytes[5] << 8)));
...
static int _M_DRV_MC36XX_ReadData(float faOutput[M_DRV_MC36XX_AXES_NUM]) {
  ...
  faOutput[M_DRV_MC36XX_AXIS_X] =
      (float)((_waRaw[M_DRV_MC36XX_AXIS_X] * s_fMC36XX_Sensitivity));
  faOutput[M_DRV_MC36XX_AXIS_Y] =
      (float)((_waRaw[M_DRV_MC36XX_AXIS_Y] * s_fMC36XX_Sensitivity));
  faOutput[M_DRV_MC36XX_AXIS_Z] =
      (float)((_waRaw[M_DRV_MC36XX_AXIS_Z] * s_fMC36XX_Sensitivity));
  return (M_DRV_MC36XX_RETCODE_SUCCESS);
}
...
int M_DRV_MC36XX_SPIHSMode(void) {
  ...
  _M_DRV_MC36XX_SetMode(
      (e_m_drv_mc36xx_mode_t)_M_DRV_MC36XX_REG_MODE_C_MODE(_bPreMode));
 ...
 *****************************************************************************/
int M_DRV_MC36XX_ConfigRegRngResCtrl(e_m_drv_mc36xx_range_t eCfgRange,
                                     e_m_drv_mc36xx_res_t eCfgResolution) {
  M_PRINTF("[%s]\r\n", __func__);

  uint_dev _bPreMode = 0;
  float _faRange[E_M_DRV_MC36XX_RANGE_END] = {19.614f,  39.228f,  78.456f,
                                              156.912f, 117.684f, 235.368f};
  float _faResolution[E_M_DRV_MC36XX_RES_END] = {32.0f,  64.0f,   128.0f,
                                                 512.0f, 2048.0f, 8192.0f};
  ...
  M_PRINTF("[%s] REG[0x%02X] 0x%02X\r\n", __func__, E_M_DRV_MC36XX_REG_RANGE_C,
           s_bCfgRngResol);
...
int M_DRV_MC36XX_SetSniffDetectCount(uint8_t axis, uint8_t SniffCount) {
  ...
  _M_DRV_MC36XX_REG_WRITE(E_M_DRV_MC36XX_REG_SNIFF_CFG, &s_bCfgSniffCfg, 1);
  M_PRINTF("0x%x : s_bCfgSniffCfg:%x\r\n", E_M_DRV_MC36XX_REG_SNIFF_CFG,
           s_bCfgSniffCfg);
  M_PRINTF("0x%x : s_bCfgSniffThr:%x\r\n", E_M_DRV_MC36XX_REG_SNIFFTH_C,
           s_bCfgSniffThr);
  M_PRINTF("[%s] REG[0x%02X] 0x%02X", __func__, E_M_DRV_MC36XX_REG_SNIFF_CFG,
           s_bCfgSniffCfg);
...
int M_DRV_MC36XX_EnableFIFO(e_m_drv_mc36xx_fifo_ctl_t eCtrl,
  ...
  if (E_M_DRV_MC36XX_RES_12BIT < _M_DRV_MC36XX_REG_RANGE_C_RES(_bRegRANGE_C))
    M_DRV_MC36XX_ConfigRegRngResCtrl(
        (e_m_drv_mc36xx_range_t)_M_DRV_MC36XX_REG_RANGE_C_RANGE(_bRegRANGE_C),
...
int M_DRV_MC36XX_ReadRegMap(uint8_t baRegMap[M_DRV_MC36XX_REG_MAP_SIZE]) {
  ...
  for (_bIndex = 0; _bIndex < M_DRV_MC36XX_REG_MAP_SIZE; _bIndex++) {
    ...
    if (0 != baRegMap) baRegMap[_bIndex] = _bRegData;
  }
  return (M_DRV_MC36XX_RETCODE_SUCCESS);
}
 ...
 *****************************************************************************/
int M_DRV_MC36XX_ConfigINT(uint8_t bFifoThreshEnable, uint8_t bFifoFullEnable,
                           uint8_t bFifoEmptyEnable, uint8_t bACQEnable,
                           uint8_t bWakeEnable) {
  M_PRINTF("[%s]\r\n", __func__);
  ...
  s_bCfgINT =
      (((bFifoThreshEnable & 0x01) << 6) | ((bFifoFullEnable & 0x01) << 5) |
       ((bFifoEmptyEnable & 0x01) << 4) | ((bACQEnable & 0x01) << 3) |
       ((bWakeEnable & 0x01) << 2) | M_DRV_MC36XX_CFG_INT_MODE_DEFAULT);
