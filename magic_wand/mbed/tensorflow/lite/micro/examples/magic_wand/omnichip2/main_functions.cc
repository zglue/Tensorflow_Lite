...
/* Only uncomment one of COLLECT_MODE or RUN_MODE */
//#define COLLECT_MODE
#define RUN_MODE
...
void loop() {
#if defined(COLLECT_MODE)
  collect_data(error_reporter);
  return;
#elif defined(RUN_MODE)
  ...
  should_clear_buffer = gesture_index < kNoGesture;
